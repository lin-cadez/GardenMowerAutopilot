...
#        print(self.user)
        ...
        self.socket=None
        self.stream = serial.Serial('/dev/serial0', 115200, timeout=3)
            ...
            while reconnectTry<=maxReconnect:
                ...
                if error_indicator==0:
                    ...
                    while not found_header:
                        ...
                        header_lines = header.decode("ascii", errors="replace").split("\r\n")

                        # If RTCM already arrived in the same TCP packet, forward it to the GNSS now
                        if remainder:
                            self.stream.write(remainder)
